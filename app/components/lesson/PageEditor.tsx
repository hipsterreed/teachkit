  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Textarea id="edit-body" value={body} onChange={(e) => setBody(e.target.value)} rows={6} disabled={saving} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="edit-example">Example</Label>
        <Textarea id="edit-example" value={example} onChange={(e) => setExample(e.target.value)} rows={3} disabled={saving} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="edit-activity">Activity / Question</Label>
        <Textarea id="edit-activity" value={activity} onChange={(e) => setActivity(e.target.value)} rows={3} disabled={saving} />
      </div>
